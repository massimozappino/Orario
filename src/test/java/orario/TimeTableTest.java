...
public class TimeTableTest {
    ...
    @Test
    public void completeTimeTable() throws Exception
    {
    ...
    @Test
    public void extraTimeTable() throws Exception
    {
    ...
    @Test
    public void reducedTimeTable() throws Exception
    {
    ...
    @Test
    public void incompleteTimeTableWillBeComplete() throws Exception
    {
    ...
    @Test
    public void multipleTimeTable() throws Exception
    {
    ...
    private void InitTimeTable(String stampings) throws Exception
    {
